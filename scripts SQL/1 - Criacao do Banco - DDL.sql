...
CREATE TABLE IF NOT EXISTS RESERVA_EMBARQUE(
    ...
    DATA_EMBARQUE DATE CHECK(DATA_EMBARQUE = DATA_CHECKIN AND DATA_EMBARQUE = (SELECT DATA_PARTIDA FROM VOO AS V, RESERVA_EMBARQUE AS RE WHERE VOO.DATA_PARTIDA = RE.DATA_EMBARQUE)) NOT NULL,
